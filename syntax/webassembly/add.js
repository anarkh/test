...
const Module = (function () {
  ...
  return (
    function (Module) {
      ...
      if (!Object.getOwnPropertyDescriptor(Module.ready, '_addString')) {
        Object.defineProperty(Module.ready, '_addString', { configurable: true, get: function () { abort('You are getting _addString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } })
        Object.defineProperty(Module.ready, '_addString', { configurable: true, set: function () { abort('You are setting _addString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } })
      }
 ...
 */
    ...
    @param {boolean=} dontAddNull */
      ...
      function checkStackCookie () {
        if (ABORT) return
        const max = _emscripten_stack_get_end()
        const cookie1 = HEAPU32[((max + 4) >> 2)]
        const cookie2 = HEAPU32[((max + 8) >> 2)]
      ...
      /** @type {function(...*):?} */
      const _addString = Module._addString = createExportWrapper('addString')

      /** @type {function(...*):?} */
      const _main = Module._main = createExportWrapper('main')
